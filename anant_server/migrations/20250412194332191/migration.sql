...
-- Indexes
CREATE UNIQUE INDEX "organization_organizationName_unique" ON "organization" USING btree ("organizationName");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('anant', '20250412194332191', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250412194332191', "timestamp" = now();
