...
import 'package:anant_client/src/protocol/attendance/attendance.dart' as _i3;
import 'package:anant_client/src/protocol/user/user_role.dart' as _i4;
import 'package:anant_client/src/protocol/user/user.dart' as _i5;
import 'package:serverpod_auth_client/serverpod_auth_client.dart' as _i6;
import 'package:anant_client/src/protocol/attendance/class.dart' as _i7;
import 'package:anant_client/src/protocol/attendance/course.dart' as _i8;
import 'package:anant_client/src/protocol/auth/organization.dart' as _i9;
import 'package:anant_client/src/protocol/auth/permission.dart' as _i10;
import 'package:anant_client/src/protocol/auth/role.dart' as _i11;
import 'package:anant_client/src/protocol/auth/role_permission.dart' as _i12;
import 'package:anant_client/src/protocol/attendance/section.dart' as _i13;
...
class EndpointAttendance extends _i1.EndpointRef {
  ...
  _i2.Future<void> updateSingleAttendance(_i3.Attendance attendance) =>
  ...
  _i2.Future<void> submitCompleteAttendance(
          List<_i3.Attendance> attendanceList) =>
      caller.callServerEndpoint<void>(
        'attendance',
  ...
  _i2.Future<List<_i3.Attendance>> getUserAttendanceRecords(
          String studentAnantId) =>
      caller.callServerEndpoint<List<_i3.Attendance>>(
        'attendance',
...
class EndpointAuth extends _i1.EndpointRef {
  ...
  _i2.Future<List<Map<String, dynamic>>> bulkSignUp(List<_i5.User> userList) =>
  ...
  _i2.Future<_i6.AuthKey> signIn(
    String anantId,
    String password,
  ) =>
      caller.callServerEndpoint<_i6.AuthKey>(
        'auth',
        'signIn',
        {
          'anantId': anantId,
  ...
  _i2.Future<_i6.AuthKey> updateUser(
    int userId, {
    String? newAnantId,
    String? newPassword,
    String? newEmail,
    String? newFullName,
    _i4.UserRole? newRole,
    bool? isActive,
    String? newClassName,
...
class EndpointClasses extends _i1.EndpointRef {
  ...
  _i2.Future<_i7.Classes> createClasses(_i7.Classes cls) =>
      caller.callServerEndpoint<_i7.Classes>(
        'classes',
        'createClasses',
        {'cls': cls},
      );
  ...
  _i2.Future<_i7.Classes?> getClasses(int id) =>
      caller.callServerEndpoint<_i7.Classes?>(
        'classes',
        'getClasses',
        {'id': id},
  ...
  _i2.Future<List<_i7.Classes>> getAllClasseses() =>
      caller.callServerEndpoint<List<_i7.Classes>>(
        'classes',
        'getAllClasseses',
        {},
      );
...
class EndpointCourse extends _i1.EndpointRef {
  ...
  _i2.Future<_i8.Course> createCourse(_i8.Course course) =>
      caller.callServerEndpoint<_i8.Course>(
        'course',
        'createCourse',
        {'course': course},
      );
  ...
  _i2.Future<_i8.Course?> getCourse(int id) =>
      caller.callServerEndpoint<_i8.Course?>(
        'course',
        'getCourse',
        {'id': id},
  ...
  /// Get all Courses
  _i2.Future<List<_i8.Course>> getAllCourses() =>
      caller.callServerEndpoint<List<_i8.Course>>(
        'course',
        'getAllCourses',
        {},
      );
...
class EndpointOrganization extends _i1.EndpointRef {
  ...
  _i2.Future<_i9.Organization> createOrganization(_i9.Organization org) =>
  ...
  _i2.Future<_i9.Organization?> getOrganization(String organizationName) =>
      caller.callServerEndpoint<_i9.Organization?>(
        'organization',
        'getOrganization',
        {'organizationName': organizationName},
  ...
  _i2.Future<List<_i9.Organization>> getAllOrganizations() =>
...
class EndpointPermission extends _i1.EndpointRef {
  ...
  _i2.Future<_i10.Permission?> createPermission(
    String slug,
    String? description,
    String? module,
  ) =>
      caller.callServerEndpoint<_i10.Permission?>(
        'permission',
        'createPermission',
        {
          'slug': slug,
  ...
  /// Get all permissions.
  _i2.Future<List<_i10.Permission>> getAllPermissions() =>
      caller.callServerEndpoint<List<_i10.Permission>>(
        'permission',
        'getAllPermissions',
        {},
      );
  ...
  _i2.Future<List<_i10.Permission>> getPermissionsByModule(String module) =>
      caller.callServerEndpoint<List<_i10.Permission>>(
        'permission',
  ...
  /// Update a permission.
  _i2.Future<_i10.Permission?> updatePermission(
    int permissionId,
    String? description,
    String? module,
  ) =>
...
class EndpointRole extends _i1.EndpointRef {
  ...
  /// Create a new role.
  _i2.Future<_i11.Role?> createRole(
    String name,
    String slug,
    String? description,
    String? organizationName,
    bool isSystemRole,
      ...
      caller.callServerEndpoint<_i11.Role?>(
        'role',
        'createRole',
        {
          'name': name,
  ...
  _i2.Future<List<_i11.Role>> getRoles({String? organizationName}) =>
  ...
  /// Update a role.
  _i2.Future<_i11.Role?> updateRole(
    int roleId,
    String? name,
    String? description,
  ) =>
  ...
  _i2.Future<_i12.RolePermission?> assignPermission(
    int roleId,
    int permissionId,
  ) =>
  ...
  _i2.Future<List<_i10.Permission>> getPermissionsForRole(int roleId) =>
      caller.callServerEndpoint<List<_i10.Permission>>(
        'role',
...
class EndpointSection extends _i1.EndpointRef {
  ...
  _i2.Future<_i13.Section> createSection(_i13.Section section) =>
      caller.callServerEndpoint<_i13.Section>(
        'section',
        'createSection',
        {'section': section},
      );
  ...
  _i2.Future<_i13.Section?> getSection(int id) =>
      caller.callServerEndpoint<_i13.Section?>(
        'section',
        'getSection',
        {'id': id},
  ...
  _i2.Future<List<_i13.Section>> getAllSections() =>
      caller.callServerEndpoint<List<_i13.Section>>(
        'section',
        'getAllSections',
        {},
      );
...
class EndpointSettings extends _i1.EndpointRef {
  ...
  _i2.Future<_i14.OrganizationSettings?> getSettings() =>
      caller.callServerEndpoint<_i14.OrganizationSettings?>(
        'settings',
        'getSettings',
        {},
      );
...
class EndpointTransaction extends _i1.EndpointRef {
  ...
  _i2.Future<_i15.MonthlyFeeTransaction> createMonthlyFeeTransaction(
          _i15.MonthlyFeeTransaction txn) =>
      caller.callServerEndpoint<_i15.MonthlyFeeTransaction>(
        'transaction',
  ...
  _i2.Future<_i15.MonthlyFeeTransaction?> getMonthlyFeeTransaction(
    String month,
    String anantId,
  ) =>
      caller.callServerEndpoint<_i15.MonthlyFeeTransaction?>(
  ...
  _i2.Future<List<_i15.MonthlyFeeTransaction>> getAllMonthlyFeeTransactionUser(
          String anantId) =>
      caller.callServerEndpoint<List<_i15.MonthlyFeeTransaction>>(
        'transaction',
        'getAllMonthlyFeeTransactionUser',
        {'anantId': anantId},
      );

  _i2.Future<List<_i15.MonthlyFeeTransaction>> getAllMonthlyFeeTransactionOrg(
          String organizationName) =>
      caller.callServerEndpoint<List<_i15.MonthlyFeeTransaction>>(
        'transaction',
...
class EndpointUser extends _i1.EndpointRef {
  ...
  _i2.Future<_i5.User?> me(int userId) => caller.callServerEndpoint<_i5.User?>(
        'user',
        'me',
        {'userId': userId},
      );
  ...
  _i2.Future<_i5.User?> getByAnantId(String anantId) =>
  ...
  _i2.Future<List<_i5.User>> getFilteredUsers(
    String sectionName,
    String className,
    String organizationName,
    String role,
  ...
  _i2.Future<_i5.User?> updateInitialPassword(int userId) =>
      caller.callServerEndpoint<_i5.User?>(
        'user',
  ...
  _i2.Future<List<_i5.User>> searchUsers(
    String className,
    String sectionName,
    String organizationName,
    String query,
