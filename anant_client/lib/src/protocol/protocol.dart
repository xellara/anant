...
import 'auth/user_role_assignment.dart' as _i17;
import 'enrollement.dart' as _i18;
import 'exam.dart' as _i19;
import 'fee_record.dart' as _i20;
import 'notification.dart' as _i21;
...
import 'package:anant_client/src/protocol/announcement.dart' as _i27;
import 'package:anant_client/src/protocol/attendance/attendance.dart' as _i28;
import 'package:anant_client/src/protocol/user/user.dart' as _i29;
import 'package:anant_client/src/protocol/attendance/class.dart' as _i30;
import 'package:anant_client/src/protocol/attendance/course.dart' as _i31;
import 'package:anant_client/src/protocol/notification.dart' as _i32;
import 'package:anant_client/src/protocol/auth/organization.dart' as _i33;
import 'package:anant_client/src/protocol/auth/permission.dart' as _i34;
import 'package:anant_client/src/protocol/auth/role.dart' as _i35;
import 'package:anant_client/src/protocol/attendance/section.dart' as _i36;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i17.UserRoleAssignment) {
      return _i17.UserRoleAssignment.fromJson(data) as T;
    }
    if (t == _i18.Enrollment) {
      return _i18.Enrollment.fromJson(data) as T;
    }
    if (t == _i19.Exam) {
      return _i19.Exam.fromJson(data) as T;
    }
    if (t == _i20.FeeRecord) {
      return _i20.FeeRecord.fromJson(data) as T;
    }
    if (t == _i21.Notification) {
      return _i21.Notification.fromJson(data) as T;
    }
    if (t == _i22.Subject) {
    ...
    if (t == _i1.getType<_i17.UserRoleAssignment?>()) {
      return (data != null ? _i17.UserRoleAssignment.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i18.Enrollment?>()) {
      return (data != null ? _i18.Enrollment.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i19.Exam?>()) {
      return (data != null ? _i19.Exam.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i20.FeeRecord?>()) {
      return (data != null ? _i20.FeeRecord.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i21.Notification?>()) {
      return (data != null ? _i21.Notification.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i27.Announcement>) {
      return (data as List)
          .map((e) => deserialize<_i27.Announcement>(e))
          .toList() as T;
    }
    if (t == List<_i28.Attendance>) {
      return (data as List).map((e) => deserialize<_i28.Attendance>(e)).toList()
          as T;
    }
    ...
    if (t == List<_i30.Classes>) {
      return (data as List).map((e) => deserialize<_i30.Classes>(e)).toList()
          as T;
    }
    if (t == List<_i31.Course>) {
      return (data as List).map((e) => deserialize<_i31.Course>(e)).toList()
          as T;
    }
    ...
    if (t == List<_i36.Section>) {
      return (data as List).map((e) => deserialize<_i36.Section>(e)).toList()
          as T;
    }
    if (t == List<_i37.MonthlyFeeTransaction>) {
      return (data as List)
          .map((e) => deserialize<_i37.MonthlyFeeTransaction>(e))
          .toList() as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i17.UserRoleAssignment) {
      return 'UserRoleAssignment';
    }
    if (data is _i18.Enrollment) {
      return 'Enrollment';
    }
    if (data is _i19.Exam) {
      return 'Exam';
    }
    if (data is _i20.FeeRecord) {
      return 'FeeRecord';
    }
    if (data is _i21.Notification) {
      return 'Notification';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'UserRoleAssignment') {
      return deserialize<_i17.UserRoleAssignment>(data['data']);
    }
    if (dataClassName == 'Enrollment') {
      return deserialize<_i18.Enrollment>(data['data']);
    }
    if (dataClassName == 'Exam') {
      return deserialize<_i19.Exam>(data['data']);
    }
    if (dataClassName == 'FeeRecord') {
      return deserialize<_i20.FeeRecord>(data['data']);
    }
    if (dataClassName == 'Notification') {
      return deserialize<_i21.Notification>(data['data']);
    }
